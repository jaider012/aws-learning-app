        ...
        <VStack space="lg" mb={30}>
          <Box p={16} bg="$backgroundCardLight" borderRadius={12}>
            ...
            <Text size="sm" color="$secondary500" mb={12}>
              Learn how to design distributed systems and build solutions using
              AWS services.
            </Text>
          ...
          <Box p={16} bg="$backgroundCardLight" borderRadius={12}>
            ...
            <Text size="sm" color="$secondary500" mb={12}>
              Learn how to develop, deploy and debug cloud-based applications
              using AWS.
            </Text>
        ...
        <VStack space="md" mb={16}>
          <Box p={16} bg="$backgroundCardLight" borderRadius={12}>
            ...
            <Text size="sm" color="$secondary500" mb={16}>
              Custom learning path for building serverless applications using
          ...
          <Box p={16} bg="$backgroundCardLight" borderRadius={12}>
            ...
            <Text size="sm" color="$secondary500" mb={16}>
              Custom learning path for deploying containerized applications
